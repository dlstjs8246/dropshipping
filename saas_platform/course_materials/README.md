...
> ⚠️ **2026 현실 체크 (시작 전 필독)**: 본 강의의 일부 숫자 가정은 2024년 이전 환경 기준입니다. De Minimis 폐지(2025-08) + 4-Layer 관세 + 광고비 상승 환경에서 가격 floor·마진·시간·타임라인 모두 ±50%p 변동 가능. **자세한 갱신은 [Week 1 상단 박스](./Week01_AI_Dropshipping_Intro.md) + [Appendix F 흔한 실수 12선](./Appendix_F_Common_Mistakes_10.md) 필독**. 프레임워크는 그대로, 숫자만 본인 카테고리로 재계산.
...
- 🔗 [Appendix E: 용어집 (ROAS·CVR·DDP·HTS·CoT·RAG·MoCRA·IOR·MCP 등 130+ 용어)](./Appendix_E_Glossary.md) ← **매 주차 옆 탭에**
...
- **Week 02**: 🔗 [프롬프트 엔지니어링 + 필터링 (Kill Criteria)](./Week02_Prompt_Engineering_Kill_Criteria.md)
- **Week 03**: 🔗 [마진 설계 + 세무 리스크 + 스코어카드 완성](./Week03_Landed_Cost_Scorecard.md)

### 🟡 Phase 2: 스토어 구축
- **Week 04**: 🔗 [AI 브랜딩 + 스토어 인프라 개설](./Week04_AI_Branding_Store_Setup.md)
- **Week 05**: 🔗 [소싱 파이프라인 연동 + AI 카피라이팅](./Week05_Sourcing_and_Copywriting.md)
- **Week 06**: 🔗 [AI 코딩 (Cursor) + 스토어 기술적 최적화](./Week06_Cursor_Coding_Optimization.md)

### 🟠 Phase 3: 마케팅 & 런칭
- **Week 07**: 🔗 [크리에이티브 공장 (AI 에셋 대량 생산)](./Week07_AI_Creative_Factory.md)
- **Week 08**: 🔗 [제휴 마케팅 (오가닉 바이럴) 세팅](./Week08_TikTok_Affiliate_Outreach.md)
- **Week 09**: 🔗 [오가닉 성과 분석 + 소액 유료 광고(Spark Ads)](./Week09_SparkAds_and_Organic.md)

### 🟣 Phase 4: AI Agent & 자동화
- **Week 10**: 🔗 [운영 자동화 1단계 (Make.com 발주/CS 자동화)](./Week10_Auto_Fulfillment_CS.md)
- **Week 11**: 🔗 [지능형 RAG 고객센터 & 원가 방어 모니터링](./Week11_RAG_Price_Monitoring.md)
- **Week 12**: 🔗 [데이터 기반 스케일업 & 피벗(Pivot)](./Week12_Data_Driven_ScaleUp.md)

### 🚀 Phase 5: 확장 & 종합
- **Week 13**: 🔗 [워크플로우 고도화 (VIP 고객 관리)](./Week13_Advanced_Workflows.md)
- **Week 14**: 🔗 [최종 리뷰 및 자체 SaaS (Command Center) 런칭](./Week14_Final_Review_SaaS_Pitch.md)
