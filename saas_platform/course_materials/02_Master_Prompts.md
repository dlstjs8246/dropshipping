...
>
> ⚠️ **% 효과 주장에 대한 중요 안내**: 본 자료 곳곳의 "+30~50% 복귀율", "광고비 -15~25%", "AOV +30~50%", "ROAS +50~100%", "응답률 5%" 등 % 수치는 **업계 보고된 best-case 또는 평균 추정치**이지 보장값이 아닙니다. 실제 효과는 본인 카테고리·페르소나·실행 품질에 따라 ±50%p 이상 변동 가능. **KPI 목표로 설정 X — 본인 측정값을 기준 baseline으로 삼고 상대 비교**하세요. (예: "복귀율 +30%"가 아니라 "본인 1주차 baseline 5% → 4주차 6.5%인지" 측정).
>
> **구조**:
...
4. 판매가 $50~$150 (2026 갱신, 이전 $25~$80): De Minimis 폐지 + 4-Layer 관세 환경에서 $50 미만은 마진 확보 거의 불가. 충동구매 + 마진 30% 동시 충족 구간이 상향됨.
...
[카테고리 → §N 매핑]
- 상품·니치 발굴: §1, §13, §19, §47 (IP 사전 점검)
- 카피·상세페이지: §2, §15, §28, §32, §33
- 브랜드·로고·톤: §16, §17, §36
- 영상·이미지·음성: §5, §25, §26, §32, §43 (Image SEO)
- 광고: §20, §30, §34
- 크리에이터·DM: §3, §4, §6, §7, §45 (Authenticity), §46 (Brief)
- HTS·관세·법적: §18, §47
- 이메일·CRM·SMS: §11, §29, §35
- CS·분쟁·환불: §21, §22, §42 (Repeat Refunder)
- 데이터 분석·LTV: §8, §9, §10, §35, §41 (Cross-sell)
- 사업 진단·결단: §31, §38, §40 (이번 주 우선순위)
- 멘탈·번아웃: §38
- 가격 전략: §44 (Tiered)
- AI 도구 선택: §12
