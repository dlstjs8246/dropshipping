...
* **0:10 - 0:40 (30분)**: [이론] Landed Cost 산출과 De Minimis 폐지(2025) + 중국발 IEEPA 125% 관세
* **0:40 - 0:50 (10분)**: ☕ 쉬는 시간
...
### 2. De Minimis 폐지(2025) + IEEPA 관세 + 경제적 넥서스 (Economic Nexus)

2025년 미국은 **De Minimis(800달러 이하 면세) 조항을 전면 폐지**했습니다. 이전엔 $800 이하 소포는 무관세 통과였는데, 이제는 **모든 소포가 정식 통관 + HTS 분류 + 관세 부과** 대상입니다.

게다가 중국발 상품에는 **IEEPA(국제비상경제권한법) 기반 추가 관세**가 누적 적용됩니다 — 일반 HTS 관세 + Section 301 + IEEPA = **합계 125% 이상이 표준**. 보수적 계산을 위해 본 강의는 **"소싱가의 125%를 관세로 가정"** 합니다.

또한 주마다 세금을 걷는 **'Economic Nexus' 법안** 때문에 각 주별 소비세(Sales Tax)도 신경 써야 합니다. 다행히 Shopify 내장 Tax 시스템 + AI 보조로 자동 계산이 가능합니다.

> **핵심 변화 요약**: "$800 이하 무관세" 시대는 끝남. 1달러짜리 소포도 관세 부과. 본 강의 마진 계산식은 이 변화를 반영해 보수적으로 설계됨.
