...
❌ **증상**: 소싱가 $8 + 판매가 $30 = "마진 73%!" 라고 노션에 적음. 통관 + 관세 125% + 국제배송비 + 결제수수료 + 광고비 미반영.

✅ **올바른 공식**:
```
실제 마진 = 판매가 − (소싱가 + 국제배송비 + 관세125% + 결제수수료3% + 광고비/주문 + Returnless 충당 5%)
```
30% 이상이어야 광고비·환불·재투자 흡수 가능.

**왜 치명적인가**: $8 상품 → 진짜 Landed Cost ~$22 → 판매가 $30이면 마진 27%. 광고 1번에 적자.
